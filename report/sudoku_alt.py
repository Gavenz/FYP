...
class SudokuTeachViz:
    ...
    def apply_event(self, event):
        ...
        if et in ('base_case', 'solved'):
            ...
            # highlight dead-end cell in red
            self.clear_conflicts()
            self.show_conflicts([(r, c)])   # reuse existing red highlight system
    ...
    def on_prev(self, _):
        ...
        board, ev, hi_cell, stack_frames = self.history[-1]
